	...
	public function index($url_name)
	{
		...
		if(empty($company)){
			...
			$sql  = "SELECT DISTINCT on (item_name) item_name, item_id,item_value, item_description->'image' AS image,
					item_description->'description' AS description,company_cover_image, company_logo,company_name, company_opening_hour, company_closing_hour, item_category, category_name
					from items
